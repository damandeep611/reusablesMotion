      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-lg border p-4">
            ...
            <p>
              Spectrum UI is not a component library. It is a collection of
          ...
          <div className="rounded-lg border p-4">
            ...
            <p>
              The goal is to provide beautiful, accessible, and customizable
              components that you can adapt to your needs.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <details className="border rounded-lg p-4">
            ...
            <p className="mt-2">
              No, Spectrum UI is not a component library. Is a collection of
              re-usable components for your projects.
            </p>
          </details>
          <details className="border rounded-lg p-4">
            <summary className="font-semibold cursor-pointer">
            ...
            <p className="mt-2">
              Yes, it is free for personal and commercial use. No attribution
              required.
            </p>
          </details>
          <details className="border rounded-lg p-4">
            ...
            <p className="mt-2">
              These components work in any React-based framework, including
              Next.js and Gatsby.
            </p>
          </details>
          <details className="border rounded-lg p-4">
            ...
            <p className="mt-2">
              Yes. These components use TypeScript for type safety but can be
